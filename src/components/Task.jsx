...
export default function Task() {
  ...
  const toggleComplete = async (todo) => {
    try {
      setLoading(true);
      await taskService.update(todo.id, {
        ...todo,
  ...
  // Helper: check if a task is marked as completed
  const isCompleted = (t) => t?.completed === true;

  const filteredTasks = tasks.filter((t) => {
    if (statusFilter === "all") return true;
    if (statusFilter === "pending") return !isCompleted(t); // Pending = not completed
    if (statusFilter === "completed") return isCompleted(t); // Completed = completed
    return true;
  });
                  ...
                  <form onSubmit={onSubmit}>
                    ...
                    <div className="row">
                      <div className="col-md-6 mb-3">
                        <label className="form-label" htmlFor="todoDueDate">
                          Due Date
                        </label>
                        <input
                          id="todoDueDate"
                      ...
                      <div className="col-md-6 mb-3">
                        <label className="form-label" htmlFor="todoPerson">
                          Assign to Person
                        </label>
                        <select
                          id="todoPerson"
